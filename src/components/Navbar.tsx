      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <NoSSR>
              <WalletMultiButton className="!bg-primary hover:!bg-primary/90 !shadow-lg hover:!shadow-xl transition-all duration-200" />
            </NoSSR>
          </div>
          ...
          <div className="md:hidden flex items-center space-x-2">
            <NoSSR>
              <WalletMultiButton className="!bg-primary hover:!bg-primary/90 !shadow-md" />
            </NoSSR>
            <Button
              variant="ghost"
              size="icon"
